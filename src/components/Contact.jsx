            ...
            <Container>
                <Row>
                    <Col xs={12} sm={4} md={3} className="content-aboutMe">
                        <Image className="img-thumbnail profileImg-max-width" src="images/profile-pic.jpg" alt="My Photo" thumbnail />
                    </Col>
                    ...
                    <Col xs={12} sm={3} md={3} className="content-aboutMe">
                        ...
                        <Col xs={12} md={12}>
                            <a href="https://www.facebook.com/cristiano.faustino" target="_blank"><Image className="img-icon-contacts"
                                src="images/icons/facebook-icon.png" alt="Facebook" /></a>
                            <a href="https://www.linkedin.com/in/cristianofaustino/" target="_blank"><Image className="img-icon-contacts"
                                src="images/icons/linkedin-icon.png" alt="LinkedIn" /></a>
                            <a href="https://github.com/cristiadu" target="_blank"><Image className="img-icon-contacts"
                                src="images/icons/github-icon.png" alt="Github" /></a>
                            <a href="http://www.last.fm/user/cristiadu" target="_blank"><Image className="img-icon-contacts"
